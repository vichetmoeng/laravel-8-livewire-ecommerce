                ...
                <div class="product product-style-2 equal-elem ">
                    ...
                    <div class="product-info">
                        ...
                        <div class="wrap-price"><ins>
                                ...
                                <p class="product-price">${{ $p->regular_price }}</p>
                            </del></div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="wrap-product-tab tab-style-1">
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item {{$key==0 ? 'active':''}}" id="category_{{ $category->id }}">
                            ...
                            @endphp
                            @if($c_products->count()<=0) @else <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
